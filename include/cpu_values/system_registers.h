...
// Hypervisor Configuraion Register Values - 64bit mode
#define HCR_RW_AARCH64	    (1 << 31)

#define HCR_VALUE			HCR_RW_AARCH64

// Saved Program Status Register Values
#define SPSR_MASK_ALL 		(7 << 6) // disable interrupts in the beginning

// defines the exception level to run in - initially EL1 with EL0 stack
